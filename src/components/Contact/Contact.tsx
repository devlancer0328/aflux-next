    ...
    <div className="flex bg-green-50 w-full justify-center" id="contact">
      <div className="flex flex-col container mx-xl py-24 justify-center items-center">
        ...
        <div className="flex flex-row justify-between items-center w-full">
          <div className="flex flex-col border-4 border-white w-1/2 me-8 h-full rounded-2xl p-6 items-center justify-center shadow-inner">
            <p className="mb-2">
          ...
          <div className="flex flex-col">
            <iframe
              className="w-full lg:w-[720px] relative rounded-2xl border-2 border-white shadow-inner"
