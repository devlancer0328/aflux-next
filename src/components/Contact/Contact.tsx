    ...
    <div className="flex bg-green-50 w-full justify-center" id="contact">
      <div className="flex flex-col container mx-xl pt-16 pb-0 lg:py-24 justify-center items-center">
        ...
        <div className="flex flex-col lg:flex-row justify-between items-center w-full">
          <div className="flex flex-col border-4 border-white w-full lg:w-1/2 me-0 mb-6 lg:me-8 lg:mb-0 h-full rounded-2xl p-6 items-center justify-center shadow-inner">
            <p className="mb-2">
          ...
          <div className="flex flex-col">
            <iframe
              className="w-[100vw] lg:w-[720px] relative lg:rounded-2xl border-2 border-white shadow-inner"
